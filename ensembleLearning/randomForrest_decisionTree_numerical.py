...
# SUMMARY
# Implement the random forest algorithm as we discussed in our lecture.
# Vary the number of random trees from 1 to 500. Note that you need to modify
# your tree learning algorithm to randomly select a subset of features before 
# each split. Then use the information gain to select the best feature to 
# split. Vary the size of the feature subset from {2, 4, 6}. Report in a 
# figure how the training and test errors vary along with the number of random 
# trees for each feature subset size setting. How does the performance compare 
#with bagged trees?
